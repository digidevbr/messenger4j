...
public final class AttachmentMessageEvent extends MessageEvent {
    ...
    public static AttachmentMessageEvent fromJson(JsonObject jsonObject) {
        ...
        final JsonArray attachmentsJsonArray = JsonHelper.getProperty(jsonObject, JsonHelper.Constants.PROP_MESSAGE, JsonHelper.Constants.PROP_ATTACHMENTS).getAsJsonArray();
    ...
    public static final class Attachment {
        ...
        private static Attachment fromJson(JsonObject jsonObject) {
            final String type = JsonHelper.getPropertyAsString(jsonObject, JsonHelper.Constants.PROP_TYPE);
            final AttachmentType attachmentType = (type == null ? null : AttachmentType.valueOf(type.toUpperCase()));

            Payload payload;
            if (JsonHelper.hasProperty(jsonObject, JsonHelper.Constants.PROP_PAYLOAD, JsonHelper.Constants.PROP_URL)) {
                payload = BinaryPayload.fromJson(jsonObject);
            } else if (JsonHelper.hasProperty(jsonObject, JsonHelper.Constants.PROP_PAYLOAD, JsonHelper.Constants.PROP_COORDINATES)) {
    ...
    public static final class BinaryPayload extends Payload {
        ...
        private static BinaryPayload fromJson(JsonObject jsonObject) {
            final String url = JsonHelper.getPropertyAsString(jsonObject, JsonHelper.Constants.PROP_PAYLOAD, JsonHelper.Constants.PROP_URL);
    ...
    public static final class LocationPayload extends Payload {
        ...
        private static LocationPayload fromJson(JsonObject jsonObject) {
            final Double latitude = JsonHelper.getPropertyAsDouble(jsonObject, JsonHelper.Constants.PROP_PAYLOAD, JsonHelper.Constants.PROP_COORDINATES, JsonHelper.Constants.PROP_LAT);
            final Double longitude = JsonHelper.getPropertyAsDouble(jsonObject, JsonHelper.Constants.PROP_PAYLOAD, JsonHelper.Constants.PROP_COORDINATES, JsonHelper.Constants.PROP_LONG);
